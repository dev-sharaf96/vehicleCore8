...
{
  public  class IntegrationAuthenticationAttribute : AuthorizeAttribute
    {
        public override  void OnAuthorization(HttpActionContext actionContext)
        {
            ...
            return username == WebConfigurationManager.AppSettings["MailAndMobileConfirmUID"] && password == WebConfigurationManager.AppSettings["MailAndMobileConfirmUIDPWD"];
            }
