...
namespace Tameenk.Security.Encryption
{
    public class AESEncryption
    {
        ...
        public static string EncryptString(string plainText, string sharedSecret)
        {
            ...
            {
                throw new EncryptionFaildException("Couldn't encrypt the given string.", ex);
            }
        ...
        public static string DecryptString(string cipherText, string sharedSecret)
        {
            if (string.IsNullOrEmpty(cipherText))
                throw new TameenkArgumentNullException("cipherText");
            if (string.IsNullOrEmpty(sharedSecret))
                throw new TameenkArgumentNullException("sharedSecret");
            ...
            {
                throw new DecryptionFaildException("Couldn't decrypt the given string.", ex);
            }
