...
namespace Tameenk.Data
{
    ...
    public class TameenkObjectContext : IdentityDbContext<AspNetUser>, IDbContext
    {
        #region Ctor

        //public TameenkObjectContext(string nameOrConnectionString)
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            //modelBuilder.Entity<AspNetUser>().HasMany(e => e.Roles)
            //    .WithRequired()
            //    .HasForeignKey(e => e.UserId);

            //modelBuilder.Entity<AspNetUser>().HasMany(e => e.Claims)
            //   .WithRequired()
            //   .HasForeignKey(e => e.UserId);

            //modelBuilder.Entity<AspNetUser>().HasMany(e => e.Logins)
            //    .WithRequired()
            //   .HasForeignKey(e => e.UserId);
        ...
        public IList<TEntity> ExecuteStoredProcedureList<TEntity>(string commandText, params object[] parameters) where TEntity : BaseEntity, new()
        {
            ...
            var result = this.Database.SqlQueryRaw<TEntity>(commandText, parameters).ToList();
        ...
        //    }
        //}
        public virtual void LogSqlQuery()
        {
            //Database.Log = (s) => Debug.Print(s);
        }

        public DatabaseFacade DatabaseInstance
        {
            get
            {
                return Database;
        ...
        Database IDbContext.DatabaseInstance => throw new NotImplementedException();
        #endregion
    }
}