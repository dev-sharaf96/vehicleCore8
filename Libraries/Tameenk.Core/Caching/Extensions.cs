...
namespace Tameenk.Core.Caching
{
    /// <summary>
    /// Extensions
    /// </summary>
    public static class CacheExtensions
    {
        ...
        public static T Get<T>(this ICacheManager cacheManager, string key, Func<T> acquire,int cacheTime)
        {
        ...
        public static T GetWithoutSetValue<T>(this ICacheManager cacheManager, string key, Func<T> acquire)
        {
            if (cacheManager.IsSet(key))
                return cacheManager.Get<T>(key);
