...
namespace Tameenk.Services.Implementation.Http
{
    ...
    public class ResilientHttpClient : IHttpClient
    {
        ...
        public Task<HttpResponseMessage> DeleteAsync(string uri, string authorizationToken = null, string requestId = null, string authorizationMethod = "Bearer")
        {
            ...
            return HttpInvoker(origin, async (Context Context) =>
            {
        ...
        public Task<string> GetStringAsync(string uri, bool returnResponseOnFailure = false, string authorizationToken = null, string authorizationMethod = "Bearer")
        {
            var origin = GetOriginFromUri(uri);
            ...
            return HttpInvoker(origin, async (Context Context) =>
            {
                ...
                if (!response.IsSuccessStatusCode && !returnResponseOnFailure)
                {
                    return null;
                }
