    ...
    public partial class DataSettingsManager
    {
        ...
        public virtual DataSettings LoadSettings(string filePath = null)
        {
            if (String.IsNullOrEmpty(filePath))
            {
                ...
                filePath = Path.Combine(MapPath("~/"), filePath);
                if (filePath.ToLower().Contains("neomportal") && filePath.Contains("\\Settings"))
                {
                    int firstIndex = filePath.ToLower().IndexOf("neomportal");
                    // secoundIndex = filePath.IndexOf("\\Settings");
                    filePath = filePath.Remove(firstIndex);
                    filePath += "neomportal\\Settings\\Settings.txt";
                    //filePath = filePath.Replace("\\Tameenk\\..", "");
                }
            }
        ...
        {
              return Path.Combine(MapPath("~/"), filePath);
        }
