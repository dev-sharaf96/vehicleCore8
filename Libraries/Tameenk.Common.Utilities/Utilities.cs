...
namespace Tameenk.Common.Utilities
{
    public class Utilities
    {
        ...
        //        try
        //        {
        //            string URL = HttpContextHelper.Current.Request.Url.Host;
        //            int Port = HttpContextHelper.Current.Request.Url.Port;
        //            string strPort = ":" + Port;
        //            string Protocol = "http://";
        //            if (HttpContextHelper.Current.Request.IsSecureConnection || !string.IsNullOrWhiteSpace(HttpContextHelper.Current.Request.Headers["X-Forwarded-For"]) || Port == 80)
        //            {
        //                if (HttpContextHelper.Current.Request.IsSecureConnection || !string.IsNullOrWhiteSpace(HttpContextHelper.Current.Request.Headers["X-Forwarded-For"]))
        //                {
        //                    Protocol = "https://";
        //                }
        ...
        //    get
        //    {
        //        return HttpContextHelper.Current.Request.IsSecureConnection ||
        //            HttpContextHelper.Current.Request.ServerVariables["HTTPS"].Equals("on", StringComparison.InvariantCultureIgnoreCase);
        //    }
        //}
        public static string AuthorizationHeader
        {
            get
            {
                return HttpContextHelper.Current.Request.Headers["Authorization"];
            }
        }
        ...
        //        return HttpContextHelper.Current.Request.Cookies[name].Value;
        //    else
        //        return string.Empty;
        //}
        /// <summary>
        ...
        //    if (HttpContextHelper.Current == null || HttpContextHelper.Current.Cache == null)
        //        return null;

        //    if (HttpContextHelper.Current.Cache[CacheKey] != null)
        //    {
        //        return HttpContextHelper.Current.Cache[CacheKey];
        //    }
        //    return null;
        //}
        ...
        public static object GetValueFromCache(string CacheKey)
        {
           return _cacheUtility.GetValueFromCache(CacheKey);
        }
        ...
        //    System.Web.Caching.Cache cache = HttpContextHelper.Current.Cache;
        //    lock (cache)
        //    {
        //        HttpContextHelper.Current.Cache.Add(CacheKey, obj, null, DateTime.Now.AddMinutes(1), Cache.NoSlidingExpiration, CacheItemPriority.AboveNormal, null);
        //    }
        //}
        ...
        public static void AddValueToCache(string CacheKey, object obj)
        {
            _cacheUtility.AddValueToCache(CacheKey, obj);
        }
        ...
        //    lock (cache)
        //    {
        //        HttpContextHelper.Current.Cache.Add(CacheKey, obj, null, DateTime.Now.AddMinutes(Minutes), Cache.NoSlidingExpiration, CacheItemPriority.AboveNormal, null);
        //    }
        //}
        ...
        public static void AddValueToCache(string CacheKey, object obj, int Minutes)
        {
            _cacheUtility.AddValueToCache(CacheKey, obj, Minutes);
        }
        ...
        public static void RemoveCache(string CacheKey)
        {
            _cacheUtility.RemoveCache(CacheKey);
        }
        ...
        //{
        //    foreach (DictionaryEntry key in HttpContextHelper.Current.Cache)
        //    {
        //        HttpContextHelper.Current.Cache.Remove(key.Key.ToString());
        //    }
        //}
        ...
        public static void RemoveAllCacheKey()
        {
            _cacheUtility.RemoveAllCacheKey();
        }
        ...
        static CacheUtility _cacheUtility;
        public Utilities(CacheUtility cacheUtility)
        {
        ...
        //            return HttpContextHelper.Current.Server.HtmlEncode(result);
        //        }
        //        else
        //        {
        //            return string.Empty;
        ...
        public static string GetInternalServerIP()
        {
            ...
            {
                //By Niaz Upgrade-Assistant todo
                //return HttpContextHelper.Current.Request.ServerVariables["LOCAL_ADDR"];
        ...
        public static string GetUserIPAddress()
        {
            try
            {
                ...
                //By Niaz Upgrade-Assistant todo
                // string ip = HttpContextHelper.Current.Request.ServerVariables["HTTP_X_FORWARDED_FOR"];
                string ip = HttpContextHelper.Current.Connection.RemoteIpAddress.ToString();
                if (string.IsNullOrEmpty(ip))
                {
                    // ip = HttpContextHelper.Current.Request.ServerVariables["REMOTE_ADDR"];
                }
                if (ip.Contains(","))
                    ip = ip.Split(',')[0];
        ...
        public static string GetUserAgent()
        {
            try
            {
                // return HttpContextHelper.Current.Request.UserAgent;
                return HttpContextHelper.Current.Request.Headers["User-Agent"].FirstOrDefault();
        ...
        //    try
        //    {
        //        var browser = HttpContextHelper.Current.Request.Browser;
        //        decimal numericBrowserVersion;
        //        decimal.TryParse(HttpContextHelper.Current.Request.Browser.Version, out numericBrowserVersion);
        ...
        //        }
        //        // chrome for android
        //        else if (HttpContextHelper.Current.Request.UserAgent.ToLower().Contains("android") && browser.Browser.ToLower().Contains("chrome") && (numericBrowserVersion >= 49))
        //        {
        //            return true;
        //        }
        //        //android browser
        //        else if (HttpContextHelper.Current.Request.UserAgent.ToLower().Contains("android") && numericBrowserVersion >= 4.4m)
        //        {
        //            return true;
        //        }
        //        //chrome for iOS
        //        else if (!HttpContextHelper.Current.Request.UserAgent.ToLower().Contains("android") && HttpContextHelper.Current.Request.UserAgent.ToLower().Contains("crios/") && !HttpContextHelper.Current.Request.UserAgent.ToLower().Contains("opr/") && !HttpContextHelper.Current.Request.UserAgent.ToLower().Contains("edge/"))
        //        {
        //            int strartIndex = HttpContextHelper.Current.Request.UserAgent.ToLower().IndexOf("crios/") > 0 ? HttpContextHelper.Current.Request.UserAgent.ToLower().IndexOf("crios/") : 0;
        //            string chromeVersionForIOS = HttpContextHelper.Current.Request.UserAgent.ToLower().Substring((strartIndex + 6), 4);
        ...
        //        else if (!HttpContextHelper.Current.Request.UserAgent.ToLower().Contains("android") && browser.Browser.ToLower().Contains("chrome") && numericBrowserVersion >= 45 && !HttpContextHelper.Current.Request.UserAgent.ToLower().Contains("opr/") && !HttpContextHelper.Current.Request.UserAgent.ToLower().Contains("edge/"))
        //        {
        //            return true;
        //        }
        //        else if (HttpContextHelper.Current.Request.UserAgent.ToLower().Contains("mac") && browser.Browser.ToLower().Contains("safari") && (numericBrowserVersion >= 8.4m))
        //        {
        //            return true;
        //        }
        //        // for mobile devices
        //        else if (HttpContextHelper.Current.Request.UserAgent.ToLower().Contains("iphone") && browser.Browser.ToLower().Contains("safari") && numericBrowserVersion >= 8.4m)
        //        {
        //            return true;
        //        }
        //        return false;
        ...
        //            return info;
        //        }
        //        if (HttpContextHelper.Current.Request.UserAgent.ToLower().Contains("windows phone"))
        //        {
        //            info.ErrorCode = BrowserInfo.ErrorCodes.Success;
        //            info.ErrorDescription = "Success";
        ...
        //            return info;
        //        }
        //        if (HttpContextHelper.Current.Request.UserAgent.ToLower().Contains("android"))
        //        {
        //            info.ErrorCode = BrowserInfo.ErrorCodes.Success;
        //            info.ErrorDescription = "Success";
        ...
        //            return info;
        //        }
        //        if (HttpContextHelper.Current.Request.UserAgent.ToLower().Contains("ipad"))
        //        {
        //            info.ErrorCode = BrowserInfo.ErrorCodes.Success;
        //            info.ErrorDescription = "Success";
        ...
        //            return info;
        //        }
        //        if (HttpContextHelper.Current.Request.UserAgent.ToLower().Contains("iphone"))
        //        {
        //            info.ErrorCode = BrowserInfo.ErrorCodes.Success;
        //            info.ErrorDescription = "Success";
        ...
        //            return info;
        //        }
        //        if (HttpContextHelper.Current.Request.UserAgent.ToLower().Contains("mac"))
        //        {
        //            info.ErrorCode = BrowserInfo.ErrorCodes.Success;
        //            info.ErrorDescription = "Success";
        ...
        //        string generatedReportDirPath = Utilities.GetAppSetting("PdfCompaniesFilesBaseFolder");
        ...
        //        string generatedReportDirPath = Utilities.GetAppSetting("QuotationFormFilesBaseFolder");// @"D:\BcarePdf";
        ...
        //    string generatedImageDirBasePath = Utilities.GetAppSetting("ComprehensiveImageFilesBaseFolder");
        //    string relativePath = Utilities.GetAppSetting("ComprehensiveImageFilesRelativePath");
        ...
        public static string GetCurrentURL
        {
            ...
            {
                //By Niaz Upgrade-Assistant todo
                //return HttpContextHelper.Current.Request.Url.AbsoluteUri;
        ...
        //public static byte[] GetFileByte(HttpPostedFileBase file)
        //{
        //    byte[] data;
        ...
        //        string userTicketDirPath = Path.Combine(Utilities.GetAppSetting("UserTicketFilesBaseFolder"), currentDate.Date.ToString("dd-MM-yyyy", new CultureInfo("en-US")), currentDate.Hour.ToString(new CultureInfo("en-US")));
        ...
        //    try
        //    {
        //        if(HttpContextHelper.Current!=null&& HttpContextHelper.Current.Request.UrlReferrer!=null)
        //            return HttpContextHelper.Current.Request.UrlReferrer.Host;
        ...
        //            HttpContextHelper.Current.Response.Cookies.Add(cookieToRemove);
        //        }
        //        return true;
        //    }
        //    catch
        ...
        public static string GetFullUrlReferrer()
        {
            try
            {
                // By Niaz
                //if (HttpContextHelper.Current != null && HttpContextHelper.Current.Request.UrlReferrer != null)
                //    return HttpContextHelper.Current.Request.UrlReferrer.AbsoluteUri;
                return HttpContextHelper.Current.Request.GetTypedHeaders().Referer.ToString();
            }
            catch
            {
                return string.Empty;
        ...
        //        DateTime.Now.ToString("HHmmss"), "pdf");
        //        string generatedReportDirPath = Utilities.GetAppSetting("CancelPolicyRequestAttachments");// @"c:\CancelPolicyRequestAttachment";
