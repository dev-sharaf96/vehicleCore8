...
namespace Tameenk.Security.CustomAttributes
{
    public class SingleSessionAuthorizeAttribute : AuthorizeAttribute
    {
        ...
        public override void OnAuthorization(HttpActionContext actionContext)
        {
            ...
            try
            {
                var url = HttpContextHelper.Current.Request.Url.Host;
                ...
                var user = HttpContextHelper.Current.User.Identity as ClaimsIdentity;
                if (user != null)
                {
                    ...
                    if (sessionData != null)
                    {
                        ...
                        if (sessionData.IsValid && (sessionData.UserIP != log.UserIP || sessionData.UserAgent != log.UserAgent)) // sessionData.IsValid && (sessionData.UserIP != log.UserIP || sessionData.UserAgent != log.UserAgent)
                        {
