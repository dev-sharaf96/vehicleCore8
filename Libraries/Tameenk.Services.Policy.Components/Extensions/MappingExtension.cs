...
namespace Tameenk.Services.Policy.Components
{
    ...
    public static class MappingExtension
    {
        ...
        /// <returns></returns>
        public static PolicyModel ToModel(this Tameenk.Core.Domain.Entities.Policy entity)
        {
            return entity.MapTo<Tameenk.Core.Domain.Entities.Policy, PolicyModel>();
        }
        ...
        /// <returns></returns>
        public static PolicyUpdatePaymentModel ToModel(this PolicyUpdatePayment entity)
        {
            return entity.MapTo<PolicyUpdatePayment, PolicyUpdatePaymentModel>();
        }
        /// <summary>
        ...
        /// <returns></returns>
        public static PolicyUpdateRequestAttachmentModel ToModel(this PolicyUpdateRequestAttachment entity)
        {
            return entity.MapTo<PolicyUpdateRequestAttachment, PolicyUpdateRequestAttachmentModel>();
        }
