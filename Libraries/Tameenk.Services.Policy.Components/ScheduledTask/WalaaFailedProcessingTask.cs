...
{
    public class WalaaFailedProcessingTask : ITask
    {
        #region Fields
        ...
        #region Ctor
        public WalaaFailedProcessingTask(IPolicyProcessingService policyProcessingService,
        ...
        {
            _policyContext.ExecutePolicy("Walaa");
        }
