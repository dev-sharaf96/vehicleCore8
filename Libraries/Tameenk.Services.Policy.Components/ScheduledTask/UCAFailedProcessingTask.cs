...
{
    public class UCAFailedProcessingTask : ITask
    {
        #region Fields
        ...
        #region Ctor
        public UCAFailedProcessingTask(IPolicyProcessingService policyProcessingService,
        ...
        {
            _policyContext.ExecutePolicy("UCA");
        }
