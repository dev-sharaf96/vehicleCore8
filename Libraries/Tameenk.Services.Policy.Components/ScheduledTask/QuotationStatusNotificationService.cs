...
{
    public class QuotationStatusNotificationService : ITask
    {
        #region Fields
        ...
        #region Ctor
        public QuotationStatusNotificationService(IPolicyProcessingService policyProcessingService,
        ...
        public async void Execute(int maxTrials, int? sendingThreshold, string commonPolicyFailureRecipient)
        {
            ...
            {
                _policyContext.CheckQuotationStatusAndSendNotification(1, false, "Quotation"); //TPL
                _policyContext.CheckQuotationStatusAndSendNotification(2, false, "Quotation");// Comprehanssive
                //_policyContext.CheckQuotationStatusAndSendNotification(2, true, "AutoleasingQuotation");//Autolease
            }
        }
