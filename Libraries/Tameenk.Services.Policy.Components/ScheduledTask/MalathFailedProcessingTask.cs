...
{
    public class MalathFailedProcessingTask : ITask
    {
        #region Fields
        ...
        #region Ctor
        public MalathFailedProcessingTask(IPolicyProcessingService policyProcessingService,
        ...
        {
            _policyContext.ExecutePolicy("Malath");
        }
