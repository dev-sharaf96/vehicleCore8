...
{
    public class BurujFailedProcessingTask : ITask
    {
        #region Fields
        ...
        #region Ctor
        public BurujFailedProcessingTask(IPolicyProcessingService policyProcessingService,
        ...
        {
            _policyContext.ExecutePolicy("Buruj");
        }
