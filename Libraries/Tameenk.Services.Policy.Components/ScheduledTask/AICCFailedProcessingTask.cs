...
{
    public class AICCFailedProcessingTask : ITask
    {
        #region Fields
        ...
        #region Ctor
        public AICCFailedProcessingTask(IPolicyProcessingService policyProcessingService,
        ...
        {
            _policyContext.ExecutePolicy("AICC");
        }
