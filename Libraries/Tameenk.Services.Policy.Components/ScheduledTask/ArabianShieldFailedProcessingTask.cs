...
{
    public class ArabianShieldFailedProcessingTask : ITask
    {
        #region Fields
        ...
        #region Ctor
        public ArabianShieldFailedProcessingTask(IPolicyProcessingService policyProcessingService,
        ...
        {
            _policyContext.ExecutePolicy("ArabianShield");
        }
