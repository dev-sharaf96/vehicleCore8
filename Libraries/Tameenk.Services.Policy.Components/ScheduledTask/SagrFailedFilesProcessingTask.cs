...
{
    public class SagrFailedFilesProcessingTask : ITask
    {
        #region Fields
        ...
        #region Ctor
        public SagrFailedFilesProcessingTask(IPolicyProcessingService policyProcessingService,
        ...
        {
            _policyContext.ExecutePolicy("Sagr");
            _policyContext.ExecutePolicy("Saqr");
        }
