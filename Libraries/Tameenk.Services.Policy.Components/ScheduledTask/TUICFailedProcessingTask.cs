...
{
    public class TUICFailedProcessingTask : ITask
    {
        #region Fields
        ...
        #region Ctor
        public TUICFailedProcessingTask(IPolicyProcessingService policyProcessingService,
        ...
        {
            _policyContext.ExecutePolicy("TUIC");
        }
