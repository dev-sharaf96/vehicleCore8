...
{
    public class GulfUnionProcessingTask2 : ITask
    {
        #region Fields
        ...
        #region Ctor
        public GulfUnionProcessingTask2(IPolicyProcessingService policyProcessingService,
        ...
        {
            _policyContext.ExecutePolicy("GulfUnion");
        }
