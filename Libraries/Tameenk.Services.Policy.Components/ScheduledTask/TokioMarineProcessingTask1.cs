...
{
    public class TokioMarineProcessingTask1 : ITask
    {
        #region Fields
        ...
        #region Ctor
        public TokioMarineProcessingTask1(IPolicyProcessingService policyProcessingService,
        ...
        {
            _policyContext.ExecutePolicy("TokioMarine");
        }
