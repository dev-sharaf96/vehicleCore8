...
{
    public class HandleMergeMissingCheckoutTransactions : ITask
    {
        #region Fields
        ...
        public HandleMergeMissingCheckoutTransactions(IPolicyProcessingService policyProcessingService)
        {
