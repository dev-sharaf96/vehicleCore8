...
{
    public class ServicesStatusNotificationService : ITask
    {
        #region Fields
        ...
        #region Ctor
        public ServicesStatusNotificationService(IPolicyProcessingService policyProcessingService,
        ...
        public async void Execute(int maxTrials, int? sendingThreshold, string commonPolicyFailureRecipient)
        {
            ...
            {
                _policyContext.CheckServicesStatusAndSendNotification("Najm");
                _policyContext.CheckServicesStatusAndSendNotification("Yakeen-getCitizenIDInfo");
                _policyContext.CheckServicesStatusAndSendNotification("Yakeen-getAlienInfoByIqama");
                _policyContext.CheckServicesStatusAndSendNotification("Yakeen-getCarInfoBySequence");
                _policyContext.CheckServicesStatusAndSendNotification("Yakeen-getCarInfoByCustom");
                _policyContext.CheckServicesStatusAndSendNotification("Yakeen-GetVehiclePlateInfo");
                _policyContext.CheckServicesStatusAndSendNotification("Yakeen-getCitizenNatAddress");
                _policyContext.CheckServicesStatusAndSendNotification("Yakeen-GetAlienAddress");
            }
        }
