...
{
    public class AXAFailedProcessingTask : ITask
    {
        #region Fields
        ...
        #region Ctor
        public AXAFailedProcessingTask(IPolicyProcessingService policyProcessingService,
        ...
        {
            _policyContext.ExecutePolicy("AXA");
        }
