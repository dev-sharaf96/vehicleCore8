...
{
    public class TawuniyaFailedProcessingTask : ITask
    {
        #region Fields
        ...
        #region Ctor
        public TawuniyaFailedProcessingTask(IPolicyProcessingService policyProcessingService,
        ...
        {
            _policyContext.ExecutePolicy("Tawuniya");
        }
