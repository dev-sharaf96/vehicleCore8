...
{
    public class AlalamiyaFailedProcessingTask : ITask
    {
        #region Fields
        ...
        #region Ctor
        public AlalamiyaFailedProcessingTask(IPolicyProcessingService policyProcessingService,
        ...
        {
            _policyContext.ExecutePolicy("Alalamiya");
        }
