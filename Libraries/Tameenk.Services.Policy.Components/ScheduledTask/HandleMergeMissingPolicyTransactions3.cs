...
{
    public class HandleMergeMissingPolicyTransactions3 : ITask
    {
        #region Fields
        ...
        public HandleMergeMissingPolicyTransactions3(IPolicyProcessingService policyProcessingService, IPolicyContext policyContext)
        {
        ...
        public async void Execute(int maxTrials, int? sendingThreshold, string commonPolicyFailureRecipient)
        {
            ...
            ////
            /// this for generate missing invoice files
            //_policyContext.GenerateMissingInvoicePdf();
            _policyProcessingService.HandleMissingProcessingQueueTransactions();
        }
