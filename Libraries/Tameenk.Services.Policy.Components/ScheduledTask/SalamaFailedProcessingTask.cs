...
{
    public class SalamaFailedProcessingTask : ITask
    {
        #region Fields
        ...
        #region Ctor
        public SalamaFailedProcessingTask(IPolicyProcessingService policyProcessingService,
        ...
        {
            _policyContext.ExecutePolicy("Salama");
        }
