...
{
    public class MedGulfProcessingTask3 : ITask
    {
        #region Fields
        ...
        #region Ctor
        public MedGulfProcessingTask3(IPolicyProcessingService policyProcessingService,
        ...
        {
            _policyContext.ExecutePolicy("MedGulf");
        }
