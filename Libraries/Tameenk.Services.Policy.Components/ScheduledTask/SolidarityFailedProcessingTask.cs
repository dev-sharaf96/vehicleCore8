...
{
    public class SolidarityFailedProcessingTask : ITask
    {
        #region Fields
        ...
        #region Ctor
        public SolidarityFailedProcessingTask(IPolicyProcessingService policyProcessingService,
        ...
        {
            _policyContext.ExecutePolicy("Solidarity");
        }
