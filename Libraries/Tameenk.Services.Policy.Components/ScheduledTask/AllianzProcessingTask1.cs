...
{
    public class AllianzProcessingTask1 : ITask
    {
        #region Fields
        ...
        #region Ctor
        public AllianzProcessingTask1(IPolicyProcessingService policyProcessingService,
        ...
        {
            _policyContext.ExecutePolicy("Allianz");
        }
