...
//using Tameenk.Cancellation.Service.Extensions;
...
//            Driver driverData = _driverRepository.Table.OrderByDescending(x => x.CreatedUtcDateTime).FirstOrDefault(d => d.DriverId == driverId);
//            if (driverData != null)
//            {
...
//            if (driverData == null || driverData.DriverLicenses == null || !driverData.DriverLicenses.Any())
//            {
...
//        {
//            Driver driverData = _driverRepository.Table.OrderByDescending(x=>x.CreatedUtcDateTime).FirstOrDefault(d => d.NIN == nin.ToString() && !d.IsDeleted);
