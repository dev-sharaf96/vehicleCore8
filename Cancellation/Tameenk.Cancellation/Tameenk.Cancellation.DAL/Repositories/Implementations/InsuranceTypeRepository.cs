...
{
    public class InsuranceTypeRepository : GRUDRepository<InsuranceType>, IInsuranceTypeRepository
    {
        public InsuranceTypeRepository(DbContext context) : base(context)
        { }
