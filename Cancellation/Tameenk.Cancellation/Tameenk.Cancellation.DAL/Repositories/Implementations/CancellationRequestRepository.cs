...
{
    public class CancellationRequestRepository : GRUDRepository<CancellationRequest>, ICancellationRequestRepository
    {
        public CancellationRequestRepository(DbContext context) : base(context)
        { }
