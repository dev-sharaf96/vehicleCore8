...
namespace Tameenk.Common.Utilities
{
    public class Utilities
    {
        ...
        public static void ctor(IHttpContextAccessor accessor) {
        ...
        public static string SiteURL
        {
            get
            {
                try
                {
                    ...
                    //}
                    if (_httpContextAccessor.HttpContext.Request.IsHttps || !string.IsNullOrWhiteSpace(_httpContextAccessor.HttpContext.Request.Headers["X-Forwarded-For"]) || Port == 80)
                    {
                        if (_httpContextAccessor.HttpContext.Request.IsHttps || !string.IsNullOrWhiteSpace(_httpContextAccessor.HttpContext.Request.Headers["X-Forwarded-For"]))
                        {
                            Protocol = "https://";
                        }
                        strPort = string.Empty;
