...
{
  public  class YakeenAuthenticationAttribute : AuthorizeAttribute
    {
        public override  void OnAuthorization(HttpActionContext actionContext)
        {
            ...
            return username == WebConfigurationManager.AppSettings["YakeenAuthenticationUserName"] && password == WebConfigurationManager.AppSettings["YakeenAuthenticationPWD"];
            }
