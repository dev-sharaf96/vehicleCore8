...
namespace Tameenk.Core.Utilities
{
    public class CarPlateUtils
    {
        static Dictionary<char, char> CarPlateCharactersEnglishToArabicMapping = new Dictionary<char, char>()
            {
                {'A', 'أ' },
                {'B', 'ب' },
                {'J', 'ح' },
        ...
        static Dictionary<char, char> CarPlateCharactersArabicToEnglishMapping = new Dictionary<char, char>()
            {
                {'أ', 'A' },
                {'ب', 'B' },
                {'ح', 'J' },
