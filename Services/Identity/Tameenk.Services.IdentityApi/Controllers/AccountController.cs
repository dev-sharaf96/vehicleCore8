...
namespace Tameenk.Services.IdentityApi.Controllers
{
    ...
    public class AccountController : IdentityBaseController
    {
        ...
        [AllowAnonymous]
        public async Task<IHttpActionResult> Register([FromBody] Tameenk.Services.Profile.Component.RegisterationModel model)
        {
        ...
        public async Task<IHttpActionResult> LoginUser(LoginViewModel model, string returnUrl = null)
        {
            Output<LoginOutput> output = new Output<LoginOutput>();
            try
            {
        ...
        public IHttpActionResult GetAccessToken([FromBody] UserData UserId)
        {
        ...
        public async Task<IHttpActionResult> ForgetPassword([FromBody] Tameenk.Services.Profile.Component.ForgetPasswordModel model)
        {
        ...
        public async Task<IHttpActionResult> ConfirmResetPassword([FromBody] Tameenk.Services.Profile.Component.ConfirmResetPasswordModel model)
        {
        ...
        public async Task<IHttpActionResult> Logout()
        {
            ...
            if (identity != null)
            {
                ...
                if (!string.IsNullOrEmpty(UserSessionId))
                {
                    ...
                    var session = _loginActiveTokensRepository.Table.Where(a => a.UserId == userId && a.UserIP == userIp && a.UserAgent == userAgent).OrderByDescending(a => a.Id).FirstOrDefault();
                    if (session != null)
                    {
        ...
        [SwaggerResponse(HttpStatusCode.OK, Type = typeof(CommonResponseModel<UserModel>))]
        [AllowAnonymous]
        public async Task<IHttpActionResult> BeginRegister([FromBody] ProfileComponent.RegisterationModel model)
        {
        ...
        [SwaggerResponse(HttpStatusCode.OK, Type = typeof(CommonResponseModel<UserModel>))]
        [AllowAnonymous]
        public async Task<IHttpActionResult> EndRegister([FromBody] ProfileComponent.RegisterationModel model)
        {
        ...
        [SwaggerResponse(HttpStatusCode.OK, Type = typeof(CommonResponseModel<UserModel>))]
        [AllowAnonymous]
        public async Task<IHttpActionResult> VerifyRegisterOTP(ProfileComponent.RegisterationModel model)
        {
        ...
        [AllowAnonymous]
        public async Task<IHttpActionResult> VerifyLoginOTP(LoginViewModel model)
        {
        ...
        [Route("api/identity/resendOTP")]
        [AllowAnonymous]
        public async Task<IHttpActionResult> ResendOTP(ProfileComponent.ResendOTPModel model)
        {
        ...
        public async Task<IHttpActionResult> BeginForgetPassword([FromBody] Tameenk.Services.Profile.Component.ForgotPasswordRequestViewModel model)
        {
        ...
        public async Task<IHttpActionResult> endForgetPassword([FromBody] Tameenk.Services.Profile.Component.ForgotPasswordRequestViewModel model)
        {
        ...
        public async Task<IHttpActionResult> VerifyForgetPasswordOTP([FromBody] Tameenk.Services.Profile.Component.VerifyForgotPasswordOTPRequestModel model)
        {
