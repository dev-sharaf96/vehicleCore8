...
namespace Tameenk.Services.IdentityApi.Controllers
{
    ...
    public class UserController : IdentityBaseController
    {
        ...
        public async Task<IHttpActionResult> GetUserPersonalInformation([FromBody]UserInputModel model)
        {
        ...
        public IHttpActionResult AddUserToPromotionProgram(UserPromotionProgramModel model)
        {
        ...
        public IHttpActionResult DownloadPolicy(string r)
        {
        ...
        public IHttpActionResult ConfirmEmailToReceivePolicy(string token)
        {
