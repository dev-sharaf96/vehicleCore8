...
namespace Tameenk.Services.IdentityApi.Controllers
{
    ...
    public class CorporateController : IdentityBaseController
    {
        ...
        public async Task<IHttpActionResult> GetCorporateAccountInfo(string channel)
        {
        ...
        public async Task<IHttpActionResult> GetCorporateUsersWithFilter([FromBody]CorporateFilterModel userFilter, int pageIndex = 1, int pageSize = int.MaxValue)
        {
        ...
        [SwaggerResponse(HttpStatusCode.BadRequest, Type = typeof(CommonResponseModel<bool>))]
        public async Task<IHttpActionResult> AddCorporateUser([FromBody] CorporateNewUserModel model)
        {
