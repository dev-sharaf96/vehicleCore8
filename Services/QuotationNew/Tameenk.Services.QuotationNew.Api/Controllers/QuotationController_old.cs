...
namespace Tameenk.Services.QuotationNew.Api.Controllers
{
    ...
    /// 
    /// </summary>
    public class QuotationController_old : BaseApiController
    {
        ...
        public QuotationController_old(IQuotationAuthorizationService authorizationService, IQuotationNewContext quotationContext
        ...
        public async Task<IHttpActionResult> GetQuote(int insuranceCompanyId, string qtRqstExtrnlId, Guid parentRequestId, int insuranceTypeCode, bool vehicleAgencyRepair, int? deductibleValue = null, string policyNo = null, string policyExpiryDate = null, string hashed = null, string channel = "Portal", bool OdQuotation = false)
        {
            DateTime excutionStartDate = DateTime.Now;
            if (channel.ToLower() == "android".ToLower() && insuranceTypeCode == 2 && insuranceCompanyId == 6)
                return Error("No Product to show");
