...
{
    public class QuotationNewServiceRequest
    {
        ...
        public virtual List<QuotationNewDriverDto> Drivers { get; set; }
        ...
        public List<QuotationNewVehicleSpecificationDto> VehicleSpecifications { get; set; }
