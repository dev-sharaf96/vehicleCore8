...
namespace Tameenk.Services.QuotationNew.Components
{
    ...
    public class QuotationNewResponseModel
    {
        public QuotationNewResponseModel()
        {
            Products = new HashSet<QuotationNewProductModel>();
        }
        ...
        public ICollection<QuotationNewProductModel> Products { get; set; }

        [JsonProperty("productType")]
        public QuotationNewProductTypeModel ProductType { get; set; }

        [JsonProperty("quotationRequest")]
        public QuotationNewRequestModel QuotationRequest { get; set; }
