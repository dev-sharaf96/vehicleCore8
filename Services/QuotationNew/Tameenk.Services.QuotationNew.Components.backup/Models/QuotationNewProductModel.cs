...
{
    [JsonObject("product")]
    public class QuotationNewProductModel
    {
        public QuotationNewProductModel()
        {
            PriceDetails = new HashSet<QuotationNewPriceDetailModel>();
            Product_Benefits = new HashSet<QuotationNewProductBenefitModel>();
        }
        ...
        public ICollection<QuotationNewPriceDetailModel> PriceDetails { get; set; }

        [JsonProperty("productBenefits")]
        public ICollection<QuotationNewProductBenefitModel> Product_Benefits { get; set; }
