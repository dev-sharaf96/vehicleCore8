...
//{
//    public class GetCompCompanyQuote : GetCompanyQuote
//    {
//        private readonly ICompanyQuotationService _companyQuotationService;

//        public GetCompCompanyQuote()
//        {
//        }

//        public GetCompCompanyQuote(ICompanyQuotationService companyQuotationService)
//        {
...
//        {
//            return await _companyQuotationService.HandleGetQuote(insuranceCompany, quoteRequest, 2, predefinedLogInfo, channel, userId, userName, log, excutionStartDate, parentRequestId, vehicleAgencyRepair, deductibleValue, policyNo, policyExpiryDate, hashed, OdQuotation);
//        }
//    }
//}
