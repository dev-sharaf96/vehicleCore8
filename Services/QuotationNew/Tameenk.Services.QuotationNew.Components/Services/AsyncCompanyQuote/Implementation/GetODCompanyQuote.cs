...
//{
//    public class GetODCompanyQuote : GetCompanyQuote
//    {
//        private readonly ICompanyQuotationService _companyQuotationService;

//        public GetODCompanyQuote()
//        {
//        }

//        public GetODCompanyQuote(ICompanyQuotationService companyQuotationService)
//        {
...
//        {
//            return await _companyQuotationService.HandleGetQuote(insuranceCompany, quoteRequest, 9, predefinedLogInfo, channel, userId, userName, log, excutionStartDate, parentRequestId, vehicleAgencyRepair, deductibleValue, policyNo, policyExpiryDate, hashed, OdQuotation);
//        }
//    }
//}
