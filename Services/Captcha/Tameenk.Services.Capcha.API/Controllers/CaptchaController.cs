...
namespace Tameenk.Services.Capcha.API
{
    public class CapchaController : BaseApiController
    {
        ...
        {
            PrometheusHttpRequestModule.IncrementCaptchaCounter();
        ...
        [AllowAnonymous]
        public IHttpActionResult ValidateCaptcha([FromBody] ValidateCaptchaModel model)
        {
            try
            {
                PrometheusHttpRequestModule.IncrementValidateCaptchaCounter();
                if (model == null)
