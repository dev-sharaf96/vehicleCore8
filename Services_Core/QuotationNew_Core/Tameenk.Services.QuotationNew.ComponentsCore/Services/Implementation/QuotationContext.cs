...
{
    public class QuotationNewContext : IQuotationNewContext
    {
        ...
        public QuotationNewContext(TameenkConfig tameenkConfig, IRepository<QuotationResponse> quotationResponseRepository, IRepository<QuotationRequest> quotationRequestRepository
        ...
        private QuotationNewRequestDetails GetQuotationRequestDetailsByExternalId(string externalId, out string exception)
        {
            IDbContext dbContext = EngineContext.Current.Resolve<IDbContext>();
            exception = string.Empty;
            try
