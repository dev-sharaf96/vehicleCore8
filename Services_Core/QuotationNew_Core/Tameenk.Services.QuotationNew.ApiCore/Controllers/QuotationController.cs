...
namespace Tameenk.Services.QuotationNew.Api.Controllers
{
    ...
    public class QuotationController : BaseApiController
    {
        ...
        [HttpGet("{insuranceCompanyId?}/{qtRqstExtrnlId?}/{parentRequestId?}/{insuranceTypeCode?}/{vehicleAgencyRepair?}/{deductibleValue?}/{policyNo?}/{policyExpiryDate?}/{hashed?}/{channel?}/{OdQuotation?}")]
        #endregion
