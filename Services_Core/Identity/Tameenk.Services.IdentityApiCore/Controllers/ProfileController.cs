...
namespace Tameenk.Services.IdentityApi.Controllers
{
    ...
    public class ProfileController : IdentityBaseController
    {
        ...
        public async Task<IActionResult> GetProfile(string userId, string channel, string language)
        {
        ...
        [SwaggerResponse(HttpStatusCode.OK, Type = typeof(Api.Core.Models.CommonResponseModel<bool>))]
        public async Task<IActionResult> GetProfileByType(string userId, int profileTypeId, string channel, string language)
        {
            Output<TameenkDAL.Models.UserProfileData> output = new Output<TameenkDAL.Models.UserProfileData>();
            output.Result = new TameenkDAL.Models.UserProfileData();
            profileLog = new ProfileRequestsLog();
        ...
        public async Task<IActionResult> DeleteVehicle(string userId, string vehicleId, string channel, string language)
        {
        ...
        [SwaggerResponse(HttpStatusCode.OK, Type = typeof(Api.Core.Models.CommonResponseModel<bool>))]
        public async Task<IActionResult> DownloadPolicyFile(string fileId, string language, string channel = "Web")
        {
        ...
        [SwaggerResponse(HttpStatusCode.OK, Type = typeof(Api.Core.Models.CommonResponseModel<bool>))]
        public async Task<IActionResult> DownloadInvoiceFilePDF(string fileId, string language, string channel = "Web")
        {
        ...
        public IActionResult GetQuotationRequestDetail(string userId, string culture, string channel = "Web")
        {
            ...
            profileLog.Headers["User-Agent"].ToString() = Utilities.GetUserAgent();
        ...
        [SwaggerResponse(HttpStatusCode.OK, Type = typeof(Api.Core.Models.CommonResponseModel<bool>))]
        public IActionResult PayPolicyUpdRequestUsingPayfort(string policyUpdReqReferenceId, string culture, string channel = "Web")
        {
            Output<string> output = new Output<string>();
            profileLog = new ProfileRequestsLog();
        ...
        [SwaggerResponse(HttpStatusCode.OK, Type = typeof(Api.Core.Models.CommonResponseModel<bool>))]
        public IActionResult PolicyUpdPayfortResult(PayfortResponse payfortResponse)
        {
            Output<string> output = new Output<string>();
            profileLog = new ProfileRequestsLog();
        ...
        public IActionResult GetUserPromotionPrograms(string useremail)
        {
        ...
        public async Task<IActionResult> JoinProgram(int promotionProgramId, string currentUserId, string userEmail, string lang = "ar")
        {
        ...
        public IActionResult ExitPromotion(string userId)
        {
            Output<bool> output = new Output<bool>();
            try
            {
        ...
        public async Task<IActionResult> GetUserOffers(string userId, string lang = "ar", string channel = "Web")
        {
        ...
        public IActionResult GetAllUserTickets(string lang = "ar", string channel = "Web")
        {
            Output<List<TicketModel>> output = new Output<List<TicketModel>>();
            output.Result = new List<TicketModel>();
            profileLog = new ProfileRequestsLog();
        ...
        public IActionResult GetAllUserNotifications(string lang = "ar", string channel = "Web")
        {
        ...
        public IActionResult GetAllTicketTypes(string lang = "ar", string channel = "Web")
        {
        ...
        [SwaggerResponse(HttpStatusCode.OK, Type = typeof(Api.Core.Models.CommonResponseModel<bool>))]
        public async Task<IActionResult> GetAllSadadBills(string userId, string channel, string language, int pageNumber = 1)
        {
        ...
        [SwaggerResponse(HttpStatusCode.OK, Type = typeof(Api.Core.Models.CommonResponseModel<bool>))]
        public async Task<IActionResult> GetVehicles([FromBody]Tameenk.Core.Domain.Dtos.MyVehicleFilter vehicleFilter, string userId, string channel, string language, int pageNumber = 1)
        {
        ...
        [SwaggerResponse(HttpStatusCode.OK, Type = typeof(Api.Core.Models.CommonResponseModel<bool>))]
        public async Task<IActionResult> GetStatistics(string userId, string channel, string language)
        {
        ...
        [SwaggerResponse(HttpStatusCode.OK, Type = typeof(Api.Core.Models.CommonResponseModel<bool>))]
        public async Task<IActionResult> GetInvoices([FromBody] Tameenk.Core.Domain.Dtos.MyInvoicesFilter invoicefilter, string userId, string channel, string language, int pageNumber = 1)
        {
        ...
        [SwaggerResponse(HttpStatusCode.OK, Type = typeof(Api.Core.Models.CommonResponseModel<bool>))]
        public async Task<IActionResult> GetPolicies([FromBody] Tameenk.Core.Domain.Dtos.MyPoliciesFilter policiesFilter, string userId, string channel, string language, int pageNumber = 1)
        {
        ...
        public IActionResult GetPromotionProgramsByTypeId(int typeId, string channel, string lang)
        {
        ...
        [SwaggerResponse(HttpStatusCode.OK, Type = typeof(Api.Core.Models.CommonResponseModel<bool>))]
        public async Task<IActionResult> SearchPolicy([FromBody] SearchPolicyModel model)
        {
        ...
        public IActionResult GetNationalAddressesByUserId(string channel, string lang, int pageIndx = 0, int pageSize = 10)
        {
        ...
        public async Task<IActionResult> CheckOffersbyNin(CheckForOffersModel model)
        {
        ...
        public async Task<IActionResult> ConfirmChangePassword([FromBody] ChangePasswordViewModel model)
        {
            model.UserId = _authorizationService.GetUserId(User);
        ...
        public async Task<IActionResult> ChangePasswordReSendOTP([FromBody] ChangePasswordViewModel model)
        {
            model.UserId = _authorizationService.GetUserId(User);
        ...
        public IActionResult GetCorporateAccountInfo(string lang, string channel)
        {
        ...
        public IActionResult GetCorporateUsersInfo(string lang, string channel)
        {
        ...
        public IActionResult GetCorporateUsersInfoByFilter(string lang, string channel, int pageIndex, string email = null, string mobile = null)
        {
            Output<CorporateAccountUsersViewModel> output = new Output<CorporateAccountUsersViewModel>();
            output.Result = new CorporateAccountUsersViewModel();
            ProfileRequestsLog log = new ProfileRequestsLog();
        ...
        public async Task<IActionResult> AddNewCorporateAccountUser(NewCoroprateUserModel model)
        {
            Output<bool> output = new Output<bool>();
        ...
        public IActionResult GetCorporateAccountPoliciesInfo(string lang, string channel)
        {
        ...
        public IActionResult GetCorporateAccountPoliciesFilterInfo(string lang, string channel, int pageIndex, string policyNumber = null, string insuredNIN = null, string sequenceOrCustomCardNumber = null, string dateFrom = null, string dateTo = null)
        {
            Output<CorporateAccountPoliciesViewModel> output = new Output<CorporateAccountPoliciesViewModel>();
            output.Result = new CorporateAccountPoliciesViewModel();
            ProfileRequestsLog log = new ProfileRequestsLog();
        ...
        [SwaggerResponse(HttpStatusCode.OK, Type = typeof(Api.Core.Models.CommonResponseModel<bool>))]
        public async Task<IActionResult> DownloadPolicy(string r)
        {
            Output<string> output = new Output<string>();
            try
            {
        ...
        [HttpPost]
        [Route("api/profile/updateNationalAddress")]
        public IActionResult UpdateNationalAddress(UpdateAddressFromProfileModel model)
        {
            string userId = _authorizationService.GetUserId(User);
            if (string.IsNullOrEmpty(userId))
                userId = User.Identity.GetUserId();
        ...
        public IActionResult ExportCorporateAccountPolicies(string lang, string channel, string policyNumber = null, string insuredNIN = null, string sequenceOrCustomCardNumber = null)
        {
            Output<CorporateAccountPoliciesViewModel> output = new Output<CorporateAccountPoliciesViewModel>();
            output.Result = new CorporateAccountPoliciesViewModel();
            ProfileRequestsLog log = new ProfileRequestsLog();
        ...
        [HttpGet]        [Route("api/profile/DownloadEInvoiceFilePDF")]        [SwaggerResponse(HttpStatusCode.OK, Type = typeof(Api.Core.Models.CommonResponseModel<bool>))]        public async Task<IActionResult> DownloadEInvoiceFilePDF(string fileId, string language, string channel = "Web")        {            string userId = _authorizationService.GetUserId(User);            if (string.IsNullOrEmpty(userId))                userId = User.Identity.GetUserId();            var output = _profileContext.DownloadEInvoiceFilePDF(fileId, language, userId, channel);            return Single(output);        }

        [HttpPost]
        [Route("api/profile/odpolicies")]
        [SwaggerResponse(HttpStatusCode.OK, Type = typeof(Api.Core.Models.CommonResponseModel<bool>))]
        public async Task<IActionResult> GetODPolicies([FromBody] Tameenk.Core.Domain.Dtos.MyPoliciesFilter policiesFilter, string channel, string language, int pageNumber = 1)
        {
        ...
        public async Task<IActionResult> SendOTP(UpdateUserProfileDataModel model)
        {
            string userId = _authorizationService.GetUserId(User);
            if (string.IsNullOrEmpty(userId))
                userId = User.Identity.GetUserId();
        ...
        public async Task<IActionResult> ReSendOTP(UpdateUserProfileDataModel model)
        {
            string userId = _authorizationService.GetUserId(User);
            if (string.IsNullOrEmpty(userId))
                userId = User.Identity.GetUserId();
        ...
        public async Task<IActionResult> UpdateUserProfileBasicData(UpdateUserProfileDataModel model)
        {
            string userId = _authorizationService.GetUserId(User);
            if (string.IsNullOrEmpty(userId))
                userId = User.Identity.GetUserId();
        ...
        public async Task<IActionResult> EmailConfirmation(UpdateUserProfileDataModel model)
        {
            string userId = _authorizationService.GetUserId(User);
            if (string.IsNullOrEmpty(userId))
                userId = User.Identity.GetUserId();
