...
namespace Tameenk.Services.IdentityApi.Controllers
{
    ...
    public class VerficationController : IdentityBaseController
    {
        ...
        public async Task<IActionResult> ResendVerficationCode([FromBody]ResendVerifyCodeModel model)
        {
        ...
        [SwaggerResponse(HttpStatusCode.OK, Type = typeof(CommonResponseModel<bool>))]
        public async Task<IActionResult> CheckoutResendVerficationCode([FromBody]ResendVerifyCodeModel model)
        {
            Output<RegisterOutput> Output = new Output<RegisterOutput>();
            Output.Result = new RegisterOutput();
        ...
        [SwaggerResponse(HttpStatusCode.OK, Type = typeof(CommonResponseModel<bool>))]
        public async Task<IActionResult> VerifyCodeForCheckout([FromBody]VerifyCodeModel model)
        {
            Output<RegisterOutput> Output = new Output<RegisterOutput>();
            Output.Result = new RegisterOutput();
            registrationLog = new RegistrationRequestsLog();
        ...
        [SwaggerResponse(HttpStatusCode.OK, Type = typeof(CommonResponseModel<bool>))]
        public async Task<IActionResult> VerifyCorporateOTP([FromBody]VerifyCorporateCodeModel model)
        {
