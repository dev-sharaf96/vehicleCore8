...
namespace Tameenk.Services.IdentityApi.Controllers
{
    ...
    public class IdentityBaseController:BaseApiController
    {
        ...
        /// <returns></returns>
        public IActionResult OutputHandler<T>(Output<T> output, dynamic logType, Output<T>.ErrorCodes code, string logMessage, string culture, string exceptionMessage = null)
