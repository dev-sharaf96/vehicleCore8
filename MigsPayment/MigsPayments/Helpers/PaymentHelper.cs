...
namespace MigsPayments.Helpers
{
    public class PaymentHelperMethods
    {
        ...
        public static string CreateSHA256Signature(IEnumerable<KeyValuePair<string, string>> list, string secureHashKey)
        {
        ...
        //    var computedHash = hash.ComputeHash(StringEncode(message));
        //    return HashEncode(computedHash);
        //}
