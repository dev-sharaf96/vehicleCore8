...
function HijriDate(year, month, date, hour, minute, second, millisecond) {
    ...
    this.getDateString = function () {
        ...
        //return '' +
        //     this.getDayName() +'-'+ date + '-' + this.getMonthName() + '-' + this.getFullYear();
    };
...
HijriDate.monthNames = ["محرم", "صفر", "ربيع الاول", "ربيع الاخر", "جماد اول", "جماد اخر",
					   "رجب", "شعبان", "رمضان", "شوال", "ذو القعده", "ذو الحجه"];

HijriDate.monthShortNames = ['محرم', 'صفر', 'ربيع اول', 'اخر', 'جماد اول', 'اخر', 'رجب', 'شعبان', 'رمضان', 'شوال', 'ذو القعده', 'ذو الحجه'];

HijriDate.weekdayNames = ["الاحد", "الاتنين", "الثلاثاء", "الاربع", "الخميس", "الجمعه", "السبت"];

HijriDate.weekdayShortNames = ['حد', 'اتنين', 'تلاتاء', 'اربع', 'خميس', 'جمعه', 'سبت'];
