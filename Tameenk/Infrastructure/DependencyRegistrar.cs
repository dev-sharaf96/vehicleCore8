...
using Tamkeen.bll.Services.Yakeen;
...
namespace Tameenk.Infrastructure
{
    public class DependencyRegistrar : IDependencyRegistrar
    {
        ...
        public void Register(ContainerBuilder builder, ITypeFinder typeFinder, TameenkConfig config)
        {
            ...
            builder.RegisterType<Tameenk.Services.Implementation.Invoices.InvoiceService>().As<Tameenk.Services.Core.Invoices.IInvoiceService>().InstancePerLifetimeScope();
